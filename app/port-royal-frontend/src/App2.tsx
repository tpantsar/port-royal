...
function App2() {
  ...
  const [primaryPile, setPrimaryPile] = useState<string | null>(null)
  const [tablePile, setTablePile] = useState<string | null>(null)
  const [discardPile, setDiscardPile] = useState<string | null>(null)
  const [researchPile, setResearchPile] = useState<string | null>(null)
